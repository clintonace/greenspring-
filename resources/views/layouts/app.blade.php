...
<head>
    ...
    <link rel="stylesheet" href="/assets/admin/assets/css/animations.css">
...
<body class="admin">
                ...
                <div class="widget widget_search">
                    <form method="get" class="searchform form-inline"
                        ...
                        <div class="form-group">
                            ...
                            <input id="widget-search-header" type="text" value="" name="search" class="form-control"
                                placeholder="Search">
                        </div>
                        <button type="submit" class="theme_button">Search</button>
                    </form>
                ...
                <div class="pull-right big-header-buttons">
                    <ul class="inline-dropdown inline-block">
                        ...
                        <li class="dropdown header-notes-dropdown">
                            <a class="header-button" data-target="#" href="index.html" data-toggle="dropdown"
                                    ...
                                    <li>
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                <h5 class="media-heading">
                                                    <a href="#">
                                                        Janet C. Donnalds <span class="pull-right">23 feb at
                                                            12:17</span>
                                                    </a>
                                                </h5>
                                                <div>
    ...
    <div class="side-dropdown side-chat dropdown">
        <a class="side-button side-chat-button" id="chat-dropdown" data-target="#" href="#" data-toggle="dropdown"
    ...
    <!-- events calendar -->
    <script src="/assets/admin/assets/js/admin/moment.min.js"></script>
    <script src="/assets/admin/assets/js/admin/fullcalendar.min.js"></script>
    <!-- range picker -->
    <script src="/assets/admin/assets/js/admin/daterangepicker.js"></script>

    <!-- charts -->
    <script src="/assets/admin/assets/js/admin/Chart.bundle.min.js"></script>
    <!-- vector map -->
    <script src="/assets/admin/assets/js/admin/jquery-jvectormap-2.0.3.min.js"></script>
    <script src="/assets/admin/assets/js/admin/jquery-jvectormap-world-mill.js"></script>
    <!-- small charts -->
    <script src="/assets/admin/assets/js/admin/jquery.sparkline.min.js"></script>
